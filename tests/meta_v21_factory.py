...
def make_spec() -> dict[str, Any]:
    ...
    spec["sources"] = {
        "SRC-META-Q3-2025": {"title": "Meta Reports Third Quarter Results", "publisher": "Meta Investor Relations", "date": "2025-10-29", "tier": 1, "document_type": "earnings-release", "locator": "investor relations quarterly results", "scope": ["revenue", "operating income", "eps", "fcf"]},
        "SRC-META-Q4-2025": {"title": "Meta Reports Fourth Quarter and Full Year Results", "publisher": "Meta Investor Relations", "date": "2026-01-28", "tier": 1, "document_type": "earnings-release", "locator": "investor relations annual results", "scope": ["revenue", "operating income", "eps", "fcf"]},
        "SRC-META-Q1-2026": {"title": "Meta Reports First Quarter Results", "publisher": "Meta Investor Relations", "date": "2026-04-29", "tier": 1, "document_type": "earnings-release", "locator": "investor relations quarterly results", "scope": ["revenue", "operating income", "eps", "fcf"]},
        "SRC-META-Q2-2026": {"title": "Meta Reports Second Quarter Results", "publisher": "Meta Investor Relations", "date": "2026-07-30", "tier": 1, "document_type": "earnings-release", "locator": "investor relations quarterly results", "scope": ["revenue", "operating income", "eps", "fcf", "capex"]},
        "SRC-META-USERS": {"title": "Meta Quarterly User and Engagement Metrics", "publisher": "Meta Investor Relations", "date": "2026-07-30", "tier": 1, "document_type": "earnings-supplement", "locator": "quarterly metrics supplement", "scope": ["users", "engagement", "advertising"]},
        "SRC-US-TREASURY": {"title": "Daily Treasury Par Yield Curve Rates", "publisher": "United States Treasury", "date": "2026-07-31", "tier": 1, "document_type": "market-rate", "locator": "treasury yield curve", "scope": ["risk-free rate"]},
        "SRC-YAHOO-PRICE": {"title": "Meta Platforms Market Quote", "publisher": "Yahoo Finance", "date": "2026-07-31", "tier": 2, "document_type": "market-data", "locator": "META quote page", "scope": ["current price"]},
        "SRC-INDEX": {"title": "Broad Equity Index Reference", "publisher": "Index provider", "date": "2026-07-31", "tier": 2, "document_type": "benchmark", "locator": "index factsheet", "scope": ["opportunity cost"]},
        "SRC-PEER": {"title": "Peer Company Public Filings", "publisher": "Peer investor relations", "date": "2026-07-31", "tier": 1, "document_type": "peer-filings", "locator": "peer filings", "scope": ["peer comparison"]}
    }
    period_source = {
